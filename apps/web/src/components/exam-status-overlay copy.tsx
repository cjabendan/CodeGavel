...
import { AlertTriangle, CheckCircle2, Clock, Lock, Pause } from "lucide-react";
...
export function ExamStatusOverlay({ status, onAction }: ExamStatusOverlayProps) {
  if (status === "active") return null;

  return (
    <div className="fixed inset-0 z-50 bg-zinc-900/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-white border border-zinc-200 rounded-2xl w-full max-w-md p-6 text-center shadow-2xl space-y-4">
        {status === "waiting" && (
          <>
